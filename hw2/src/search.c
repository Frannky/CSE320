...

{
    ...
    return response; // I guess (no return value initially)
}
...

{
    ...
    //reask : defined but not used  should I keep????
        ...
        case MENU_DATA :
            ...
            if (field_index != nchoices) {
                ...
                *ptr_name = copystr(Field_Names[*ptr_index]);
                ...
                //reask2 :  defined but not used  should I keep????
    ...
    return  0;  // return -1 when abort otherwise 0
}
