...

{
    ...
    char  *options[MAX_MENU_OPTIONS]; //* option,
    int rvals[MAX_MENU_OPTIONS];
    int j,found,len,optionlen,rval,compare,blankindex; //*addr,
    va_list pvar;
    ...
    blankindex = -1;
    va_start(pvar, n_options);//number of arguments???
...
//    fprintf(stderr, "*rval* = %d\n",rval);
//    fprintf(stderr, "MENU_MATCH = %d\n",MENU_MATCH);
//    fprintf(stderr, "MENU_NO_MATCH = %d\n",MENU_NO_MATCH);
//    fprintf(stderr, "MENU_AMBIGUOUS = %d\n",MENU_AMBIGUOUS);
...

{
    ...
    return -1; // what should return here??????????
}
...
//        fprintf(stderr,"testssss111 = %d",rval);
    }
    else {
        rval = menu_match (
                &menuval,&response,
...
//        fprintf(stderr,"testssss = %d\n",rval);
//        fprintf(stderr,"menuval = %d\n",menuval);
//        fprintf(stderr,"MENU_RETURN = %d\n",MENU_RETURN);
